...
export default function Experience() {
  ...
  return (
    <Section id={"experience-section"} className="z-10">
      <Container className="  grid gap-6 overflow-visible  text-center  before:absolute before:left-4 before:right-4 before:top-0 before:mx-auto before:border-y-[1px] before:border-color-primary  after:absolute after:bottom-0 after:left-4 after:right-4 after:mx-auto after:border-y-[1px] after:border-color-primary md:grid-cols-2  md:text-left md:before:left-8 md:before:right-8 md:after:hidden lg:grid-cols-3 lg:before:left-16 lg:before:right-16">
        ...
        <Image
          ...
          className="absolute -bottom-24 -right-56 z-10 -translate-y-1/2 md:-right-96 "
        />
      </Container>
    </Section>
  );
